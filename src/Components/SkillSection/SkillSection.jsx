...
const SkillSection = () => {
  ...
  return (
    <>
      ...
      <section
        id="skills"
        className="min-h-screen flex flex-col justify-center items-center bg-radial-gradient py-20 px-10"
        ref={sectionRef}
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
          {skills.map((skill, index) => (
            ...
            >
              ...
              />
              <h2 className="text-lg md:text-4xl font-semibold drop-shadow-2xl font-Josefin text-white ">
                {skill.name}
              </h2>
            </div>
          ))}
