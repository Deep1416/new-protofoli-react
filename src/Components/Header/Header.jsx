  ...
  return (
    ...
    >
      <div className="flex items-center md:mb-0 m-1 px-3">
            ...
            >
              <div className=" p-2 flex item-center self-center-2xl hover:bg-[#111827] rounded-lg ">
                ...
                <a
                  ...
                  href="https://www.linkedin.com/in/deependra14/"
                  target="_blank"
              ...
              <div className=" p-2 flex item-center self-center-2xl hover:bg-[#111827]  rounded-lg ">
                ...
                <a
                  ...
                  href="https://www.instagram.com/deep_1416rajput/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Instgram
              ...
              <div className=" p-2 flex item-center self-center-2xl hover:bg-[#111827]  rounded-lg">
                ...
                <a
                  className="text-center self-center ml-1 font-Pacifico p-1"
                  href="https://github.com/Deep1416"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github
        ...
        <motion.h1
          className="text-xl  font-bold hover:underline text-white px-1 "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
            ...
            <li
              className={`p-3.5 font-extrabold text-white transition-all duration-200 flex justify-center items-center cursor-pointer group ${
                activeSection === "home"
                  ...
                  : " hover:bg-yellow-300 hover:rounded-full"
          ...
          >
            <li
              className={`p-3.5 font-extrabold text-white transition-all duration-200 flex justify-center items-center cursor-pointer group ${
                activeSection === "about"
                  ? " bg-[#CBD5E1] rounded-full"
                  : " hover:bg-[#CBD5E1] hover:rounded-full"
              } ${isMobileMenuOpen ? "w-full text-center m-2" : ""}`}
            >
              <span>About Me</span>
