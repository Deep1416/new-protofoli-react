    ...
    <section id="about-section" className="min-h-screen flex items-center bg-slate-300 text-white py-[230px]">
      <div id="Contain" className="container mx-auto flex flex-col md:flex-row items-center text-center md:text-left px-4 md:px-8 lg:px-16">
        ...
        >
          ...
          <motion.p id="pTag" className=" z-30 sm:text-xl hover:transition-all hover:duration-700 hover:shadow-2xl shadow-xl self-center md:text-2xl max-w-2xl font-Josefin p-7 rounded-[30px] bg-[#303030] text-white text-justify" initial={{ opacity: 0, x: -50 }} animate={{ opacity: isVisible ? 1 : 0, x: isVisible ? 0 : -50,transition: { duration: 1, delay: 0.6 }}}>
          I'm an enthusiastic developer with a knack for crafting amazing web experiences. Curiosity and a never-ending desire to learn and grow have driven my career in technology. I enjoy working with all facets of software development, from creating elegant user interfaces with React.js and Tailwind CSS to building reliable backend systems using Node.js and Express.js. Let's examine my motivation for coding by delving further into my background.
          </motion.p>
        </div>
